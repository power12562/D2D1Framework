...
{
	//key table use MS Virtual-Key Code : https://learn.microsoft.com/ko-kr/windows/win32/inputdev/virtual-key-codes
	enum class KeyCode
	{
...
public:
    ...
    bool IsKeyDown(InputSystem::KeyCode key) const;

    bool IsKeyUp(InputSystem::KeyCode key) const;

    bool IsKey(InputSystem::KeyCode key) const;
	...
	const InputSystem::MouseState& GetMouseState();
...
private:
	...
	InputSystem::MouseState mouseState;
};
